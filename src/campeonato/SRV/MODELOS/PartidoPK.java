...
public class PartidoPK implements Serializable {
    ...
    public PartidoPK(int idPartido, int idGrupo, String idEtapa, int idCampeonato) {
    ...
    public String toString() {
        return "campeonato.SRV.MODELOS.PartidoPK[ idPartido=" + idPartido + ", idGrupo=" + idGrupo + ", idEtapa=" + idEtapa + ", idCampeonato=" + idCampeonato + " ]";
    }
